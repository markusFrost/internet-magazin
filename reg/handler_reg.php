<?php 
	...
	$patronymic = iconv( "UTF-8", "cp1251", strtolower( clear_string(  $_POST["reg_patronymic"] ) ) );
    ...
    {
    	$error[] = "Не верный код проверки!";
    }

    unset( $_SESSION['img_captcha'] ); // уничтоженеи сессии
    ...
    else
    {
    	...
    	$query = "insert into reg_user(login,pass,surname,name,patronymic,email,phone,address,datetime,ip)
					values(
						'".$login."',
						'".$pass."',
						'".$surname."',
