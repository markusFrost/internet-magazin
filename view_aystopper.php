    ...
    <div id="block-content">
        ...
        ?>
            ...
            <p id="nav-breadcrumbs">
                <a href="index.php">Главная страница</a> \ <span>' . $name_aystopper . '</span>
            </p>
            <ul id="option-list">
                <li>Вид</li>
                ...
                <li><a id="select-sort">' . $sort_name . '</a>
                    <ul id="sorting-list">
                        <li><a href="view_aystopper.php?go=' . $go . '&sort=price-asc">От дешёвых к дорогим</a></li>
                        <li><a href="view_aystopper.php?go=' . $go . '&sort=price-desc">От дорогих к дешёвым</a></li>
