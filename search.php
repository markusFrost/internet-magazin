...
<!--        <ul id="block-tovar-grid">-->
            ...
            $result = mysql_query("select * from table_products where title LIKE '%$search%' AND  visible=1 order by " . $sorting . " " . $qury_start, $link);
        ...
        <ul id="block-tovar-list">
            ...
            //Блок с пагинацией
            if ($page != 1) {
                $pstr_prev = '<li><a class="pstr-prev" href="search.php?q=' . $search . '&page=' . ($page - 1) . '">&lt</a></li>';
            }

            if ($page != $total) {
                $pstr_next = '<li><a class="pstr-next" href="search.php?q=' . $search . '&page=' . ($page + 1) . '">&gt</a></li>';
            }
            ...
            {
                echo '<center><p style="font-weight: bold;" id="search-fail">Ничего не найдено!</p></center>';
            }
            }
            else
            {
                echo '<center><p id="search-fail">Поисковое значение должно быть от 3 до 150 символов!</p></center>';
            }
            ?>
